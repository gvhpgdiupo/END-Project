                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <a href="exportpdfqrcodechk.php?qr_chk" class="au-btn au-btn-icon au-btn--blue" onclick="openandclose()" target ="_blank">
                                            ...
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php    
                                                        ...
                                                        $genqrcode = 'Created';
                                                        if(isset($_POST["genqrchk"])){
                                                            if(!empty($_POST["chk"])){
                                                                foreach($_POST["chk"] as $qrchk){
                                                                    $updateqr = "UPDATE qrcode SET status_qr = '$genqrcode' WHERE id= '$qrchk'";
                                                                    $completeqrchk = mysqli_query($con,$updateqr);           
                                                                }
                                                                echo "<script>";
                                                                echo"alert('สร้าง QR CODE สำเร็จ');";
                                                                echo "</script>";                  
                                                            }
                                                            else{
                                                                echo "<script>";
                                                                echo"alert('กรุณาเลือกก่อนว่าต้องการสร้างข้อมูลไหน');";
                                                                echo"window.location ='qrcode.php';";
                                                                echo "</script>";  
                                                            }
                                                        }
                                                        if(isset($completeqrchk)){
                                                            foreach($_POST["chk"] as $qrchk){                                                                
                                                            $sqlSelect = "SELECT * FROM qrcode  WHERE id= '$qrchk'";   
